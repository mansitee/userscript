...
(function() {
    ...
    GM_addStyle(`
.floating {background-color: #007bff;color:#ffff;border-radius:50%;width:40px;height:40px; text-align:center;line-height: 40px;position: fixed;bottom:0px;
right:6%;tleft:45%;cursor:move;box-shadow:0 0px 8px rgba(0,0,0,0.3);
font-size:30px;z-index:999999999;
-webkit-tap-highlight-color: transparent;}

.floating:hover {background-color:rgba(0,123,255, 0.1);color: #007bff;}

.fm {display:none; position:fixed;bottom:120px;right:20px;tbox-shadow:0 1px 2px 0 rgba(60,64, 67,0.3), 0 1px 3px 1px rgba(255,255,255,0.5); border-radius:5px;
...
.fm:hover{box-shadow:0 12px 28px -5px rgba(0,0,0,0.13);-webkit-transform: translatey(5px);transform:translatey(-10px); -webkit-transition: all 0.3s; transition: transform 0.35s ease-in-out, opacity 0.35s ease-in-out; opacity:0;}

.tfm:hover{ttransform: translate(50px);
  ttransition: transform 0.5s ease, opacity 0.2s ease;
  opacity:1;}


.fm .mg {display: grid;grid-template-columns: repeat(3,1fr); padding:5px; background-color:rgba(0,123,255, 0.1);}
...
.fm .glink:nth-of-type(2) {tbackground-color: #33c2ff;}
.fm .glink:nth-of-type(3) {tbackground-color:#33ff57;}


.fm a, .fm button {display:block;padding:6px 10px;text-decoration:none;color: #333;border-bottom:1px solid #eee; width:100%;background:none;border: none;text-align:left;cursor:move;
font-size:16px; transition: background-color 0.3s, opacity 0.3s;-webkit-tap-highlight-color: transparent;}

.fm a:hover {background: none;cursor:move;width:100%; font-weight:bold;color:#007bff; }

.fm button:hover {background-color: rgba(0, 123, 255, 0.1); opacity: 0.8; -webkit-tap-highlight-color: transparent;color: #007bff; }

.fm a:last-child, .fm button:last-child {border-bottom: none;}

.fm .copy {background-color:rgba(0,123,255, 0.1); opacity:0.8;font-weight: bold;color:#007bff;padding:10px; text-align:center;width:100%; border-radius:30px 30px 0 0; border-top:2px solid white; }  `);
    ...
    const menu = $(`<div class="fm"> <a href="https://www.google.com/search?hl=id&safe=off&q=${encodeURIComponent(window.location.href)}" target="_blank">• Google No</a>


    <div class="mg"> <a href="https://www.pornhub.com/video/search?search=${encodeURIComponent(window.location.href)}" class="glink" id="glink-1">PHUB</a>
<a href="https://www.xvideos.com/?k=${encodeURIComponent(window.location.href)}" class="glink" id="glink"> XVID</a>
<a href="https://www.xnxx.com/search/${encodeURIComponent(window.location.href)}" class="glink" id="glink"> XNXX</a>     </div> 
...
<button id="redirect">Redirect URL</button>
<button id="eruda">Eruda Consol</button>
...
<div class="mg"> <a href="https://mansitee.github.io/app/" class="glink" id="glink-1"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <rect x="0" y="0" width="24" height="24" fill="#fff" rx="5" ry="5"/> <circle cx="12" cy="8" r="4" fill="#007bff"/> <path d="M12 14c-5.52 0-10 4.48-10 10h20c0-5.52-4.48-10-10-10z" fill="#007bff"/> </svg> </a>
                
<a href="https://mansitee.github.io/app/l"class="glink" id="glink"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <rect x="0" y="0" width="24" height="24"fill="#fff" rx="5"ry="5"/> <path d="M12 16.5l-6-6h4v-5h4v5h4l-6 6zm-6 1h12v2H6v-2z"fill="#007bff"/>
</svg> </a>
 
<a href="https://m.youtube.com" class="glink" id="glink"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <rect x="0" y="0" width="24" height="24" rx="5" ry="5" fill="#fff"/> <path d="M8 16.5l8-4.5-8-4.5v9z" fill="#007bff"/> </svg> </a>
            </div>
        </div>
    `);
    $('body').append(menu);
    ...
    $(document).on('click', function(event) {
        if (!$(event.target).closest('.floating, .fm').length) {
            menu.hide();
        }
    });

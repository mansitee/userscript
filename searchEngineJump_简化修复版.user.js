...
// @include        /^https?:\/\/www\.wuzhuiso\.com\/s/
...
// @include        /^https?:\/\/(www\.)?yandex\..+\/search\/\?(.+&)?text=/
...
// @include        /^https?:\/\/search\.bilibili\.com\/all\?keyword/
...
// @include        /^https?:\/\/music\.91q\.com\/search/
...
// @include        /^https?:\/\/www\.kugou\.com\/[a-z\.\/]+search/
// @include        /^https?:\/\/music\.163\.com\/.*/
// @include        /^https?:\/\/(www\.)?kuwo\.cn\/search/
...
// @include        /^https?:\/\/www\.pixiv\.net\/tag/
// @include        /^https?:\/\/www\.deviantart\.com\/search/
// @include        /^https?:\/\/www\.iconfont\.cn\/search/
...
// @include        /^https?:\/\/(www\.)?btsow\.hair\/search/
// @include        /^https?:\/\/(www\.)?thepiratebay\.org\/search/
// @include        /^https?:\/\/www\.breadsearch\.com\/search/
// @include        /^https?:\/\/www\.cilibaba\.com\/search\//
// @include        /^https?:\/\/www\.bthave\.cc\/search\//
// @include        /^https?:\/\/(www\.)?btku\.org\/q\//
// @include        /^https?:\/\/(www\.)?tor(rent)?kitty\.(com|org|net|tv)\/search\//
// @include        /^https?:\/\/(www\.)?btmovi\.[a-z]{2,6}\/so/
// @include        /^https?:\/\/(www\.)?btmet[0-9]{2,3}\.[a-z]{2,6}\/search/
// @include        /^https?:\/\/(www\.)?(xccl55|bthub031)\.xyz(\/cn)?\/search/
// @include        /^https?:\/\/(www\.)?yhg007\.com\/search/
// @include        /^https?:\/\/(www\.)?yuhuage\.[a-z]{3,6}\/search/
// @include        /^https?:\/\/(www\.)?clmclm\.com\/search/
// @include        /^https?:\/\/(www\.)?cld[0-9]{2,3}\.buzz\/search/
// @include        /^https?:\/\/(www\.)?clg5\.info\/search/
// @include        /^https?:\/\/(www\.)?zzb1\.vip\/search/
// @include        /^https?:\/\/(www\.)?zhongziso\.com\/list/
// @include        /^https?:\/\/(www\.)?(0cili|0magnet)\.(com|org)\/search/
// @include        /^https?:\/\/(www\.)?xuesousou\.com\/search/
// @include        /^https?:\/\/s8?\.etao\.com\/search/
// @include        /^https?:\/\/search\.jd\.com\/Search\?/
// @include        /^https?:\/\/s\.taobao\.com\/search/
// @include        /^https?:\/\/s\.1688\.com\/(((selloffer|company|newbuyoffer|wiki)\/)|([a-z]+\/[a-z]+_search))/
// @include        /^https?:\/\/searchex\.yixun\.com\/html\?/
// @include        /^https?:\/\/(search)\.suning\.com\//
// @include        /^https?:\/\/list\.tmall\.com\/\/?search/
// @include        /^https?:\/\/www\.amazon\.((cn)|(com))\/s/
...
// @include        /^https?:\/\/dict\.hjenglish\.com\/(\w+\/)?(en|w)/
// @include        /^https?:\/\/dict\.hjenglish\.com\/(\w+\/)?jp/
// @include        /^https?:\/\/www\.romajidesu\.com\/translator/
// @include        /^https?:\/\/www\.zdic\.net\/search/
...
// @include        /^https?:\/\/www\.javlibrary\.com\/[a-z]{2}\/.*search/
// @include        /^https?:\/\/www\.javlibrary\.com\/[a-z]{2}\/\?v/
// @include        /^https?:\/\/(www\.)?avmoo\.cfd\/[a-z]{2}\/search/
// @include        /^https?:\/\/(www\.)?avmoo\.cfd\/[a-z]{2}\/movie/
// @include        /^https?:\/\/(www\.)?avsox\.click\/[a-z]{2}\/search/
// @include        /^https?:\/\/(www\.)?avsox\.click\/[a-z]{2}\/movie/
// @include        /^http:\/\/www\.avmemo\.com\/[a-z]{2}\/search/
// @include        /^http:\/\/www\.avmemo\.com\/[a-z]{2}\/movie/
// @include        /^https?:\/\/www\.javbus\.com\/((search\/)|(uncensored\/)|(searchstar\/))/
// @include        /^https?:\/\/www\.javbus\.com\/[A-Za-z0-9-]+$/
...
// @include        /^https?:\/\/(www\.)?libredmm\.com\//
// @include        /^https?:\/\/(www\.)?pornmd\.com\/straight/
// @include        /^https?:\/\/[a-z]{2,3}\.pornhub\.com\/.*search/
...
var engineListData = {
    custom: '',
    my: '网页-Google\n    Google, https://www.google.com/search?q=%s&ie=utf-8\n    百度, https://www.baidu.com/s?wd=%s&ie=utf-8\n    搜狗, https://www.sogou.com/web?query=%s&ie=utf8\n    360, https://www.so.com/s?q=%s&ie=utf-8\n    必应, https://cn.bing.com/search?q=%s\n    DuckDuckGo, https://duckduckgo.com/?q=%s\n    雅虎搜索, https://search.yahoo.com/search?p=%s\n    Yahoo日本, http://search.yahoo.co.jp/search?p=%s&ei=UTF-8\n    Yandex, https://www.yandex.com/search/?text=%s\n    无追搜索, https://www.wuzhuiso.com/s?q=%s\n\n视频-Youtube\n    Youtube, https://www.youtube.com/results?search_query=%s\n    奇艺, http://so.iqiyi.com/so/q_%s\n    乐视, http://so.letv.com/s?wd=%s\n    搜狐, http://so.tv.sohu.com/mts?wd=%s\n    腾讯, https://v.qq.com/x/search/?q=%s\n    acfan, https://www.acfun.cn/search?keyword=%s, data:image/x-icon;base64,\n    bilibili, http://www.bilibili.com/search?keyword=%s\n    豆瓣电影, http://movie.douban.com/subject_search?search_text=%s&cat=1002, www.douban.com\n\n音乐-网易云音乐\n    酷我音乐, http://www.kuwo.cn/search/list?key=%s\n    百度音乐, http://music.baidu.com/search?ie=utf-8&oe=utf-8&key=%s, 91q.com\n    酷狗音乐, https://www.kugou.com/yy/html/search.html#searchType=song&searchKeyWord=%s\n    网易云音乐, http://music.163.com/#/search/m/?s=%s\n    一听, http://so.1ting.com/all.do?q=%s\n    百度歌词, http://music.baidu.com/search/lrc?key=%s\n\n图片-花瓣网\n    Google图片, https://www.google.com/search?q=%s&safe=off&hl=zh-CN&tbm=isch\n    百度图片, http://image.baidu.com/search/index?tn=baiduimage&ie=utf-8&word=%s\n    360图片, http://image.haosou.com/i?q=%s\n    花瓣网, http://huaban.com/search/?q=%s\n    Pixiv, http://www.pixiv.net/search.php?word=%s\n    deviantART, http://www.deviantart.com/?q=%s, ASCII\n    Iconfont, https://www.iconfont.cn/search/index?searchType=icon&q=%s\n\n知识-知乎\n    百度百科, http://baike.baidu.com/search/word?pic=1&sug=1&word=%s\n    维基百科, https://zh.wikipedia.org/w/index.php?title=Special%3A搜索&profile=default&fulltext=Search&search=%s\n    Wikipedia, https://en.wikipedia.org/w/index.php?title=Special%3ASearch&profile=default&fulltext=Search&search=%s\n    谷歌学术, https://scholar.google.com/scholar?q=%s\n    知乎, http://www.zhihu.com/search?q=%s\n    百度文库, http://wenku.baidu.com/search?word=%s&ie=utf-8\n    豆丁文档, http://www.docin.com/search.do?searchcat=2&searchType_banner=p&nkey=%s\n    百度知道, http://zhidao.baidu.com/search?word=%s\n\n社交-Facebook\n    新浪微博, http://s.weibo.com/weibo/%s\n    豆瓣, http://www.douban.com/search?source=suggest&q=%s\n    百度贴吧, http://tieba.baidu.com/f?kw=%s&ie=utf-8\n    Twitter, https://twitter.com/search/%s\n    Facebook, https://www.facebook.com/search/top?q=%s\n\n购物-淘宝\n    淘宝, http://s.taobao.com/search?q=%s\n    天猫, http://list.tmall.com/search_product.htm?q=%s&type=p, gbk\n    京东, http://search.jd.com/Search?keyword=%s&enc=utf-8\n    苏宁, http://search.suning.com/%s/\n    当当, http://search.dangdang.com/search.php?key=%s, gbk\n    亚马逊, http://www.amazon.cn/s/ref=nb_sb_noss?field-keywords=%s\n\n下载\n    下载搜索, https://www.google.com/cse?q=%s&newwindow=1&cx=006100883259189159113%3Atwgohm0sz8q, data:image/png;base64,\n    移花宫, https://yhg007.com/search-%s-0-0-1.html\n    磁力狗, http://clg5.info/search?word=%s\n    种子搜, https://www.zhongziso.com/list/%s/1\n    磁力猫, https://www.torkitty.com/search/%s, btdigg.org\n    btsow, https://btsow.hair/search/%s\n    0cili, https://0cili.org/search?q=%s\n    学搜搜, https://www.xuesousou.com/search?q=%s\n    thepiratebay, https://thepiratebay.org/search.php?q=%s\n    //新浪微盘, http://vdisk.weibo.com/search/?type=public&keyword=%s\n    //Chrome扩展, https://chrome.google.com/webstore/search/%s\n    种子吧, http://zzb1.vip/search?wd=%s, zzb2.icu\n    磁力蜘蛛, http://www.btmovi.bio/so/%s.html\n    btmet, https://www.btmet21.xyz/search.php?q=%s\n    小草磁力, https://xccl55.xyz/search/kw-%s-1.html\n    BTHub, https://bthub031.xyz/cn/search/kw-%s-1.html\n    雨花阁, https://www.yuhuage.site/search/%s-1.html, data:image/jpeg;base64,\n    磁力帝, https://cld87.buzz/search-%s-0-0-1.html, data:image/x-icon;base64,\n    磁力猫, https://clmclm.com/search-%s-0-0-1.html, data:image/x-icon;base64,\n    // RM Down, http://www.rmdown.com/link.php?hash=%s\n    // Magent2Torrent, http://torcache.net/torrent/%s.torrent\n\n书籍-豆瓣读书\n    豆瓣读书, http://book.douban.com/subject_search?search_text=%s&cat=1001, www.douban.com\n    Google 书籍, http://books.google.com/books?q=%s, www.google.com\n    当当, http://search.dangdang.com/search.php?key=%s, gbk\n    亚马逊（中）, http://www.amazon.cn/s/ref=nb_sb_noss?field-keywords=%s\n    亚马逊（英）, http://www.amazon.com/s/ref=nb_sb_noss?field-keywords=%s, www.amazon.cn\n\n翻译-爱词霸\n    Google翻译, https://translate.google.com/?q=%s\n    沪江英语, https://dict.hjenglish.com/w/%s\n    百度翻译, http://fanyi.baidu.com/#auto/cht/%s\n    有道词典, http://dict.youdao.com/search?q=%s\n    爱词霸, http://www.iciba.com/%s\n    海词, http://dict.cn/%s\n    汉典, http://www.zdic.net/search/?q=%s\n    日语罗马音, http://www.romajidesu.com/translator/%s\n\n成人-javlibrary\n    javlibrary, http://www.javlibrary.com/cn/vl_searchbyid.php?keyword=%s\n    javbus, http://www.javbus.com/search/%s\n    avmoo, https://avmoo.cfd/cn/search/%s\n    avsox, https://avsox.click/cn/search/%s\n    PronMD, http://www.pornmd.com/straight/%s\n    pornhub, http://www.pornhub.com/video/search?search=%s\n    DMM,R18, http://www.dmm.co.jp/search/=/searchstr=%s\n    liberdmm, http://www.libredmm.com/search?utf8=%E2%9C%93&q=%s&commit=Search\n    t66y, https://www.google.com/search?q=site:t66y.com+%s, t66y.com\n    sis001, https://www.google.com/search?q=site:sis001.com+%s, sis001.com',
    simple: '网页-Google\n    Google, https://www.google.com/search?q=%s&ie=utf-8\n    百度, https://www.baidu.com/s?wd=%s&ie=utf-8\n    搜狗, https://www.sogou.com/web?query=%s&ie=utf8\n    360, https://www.so.com/s?q=%s&ie=utf-8\n    必应, https://cn.bing.com/search?q=%s\n\n视频-Youtube\n    Youtube, https://www.youtube.com/results?search_query=%s\n    奇艺, http://so.iqiyi.com/so/q_%s\n    腾讯, https://v.qq.com/x/search/?q=%s\n    bilibili, http://www.bilibili.com/search?keyword=%s\n    豆瓣电影, http://movie.douban.com/subject_search?search_text=%s&cat=1002, www.douban.com\n\n音乐-网易云音乐\n    酷我音乐, http://www.kuwo.cn/search/list?key=%s\n    百度音乐, http://music.baidu.com/search?ie=utf-8&oe=utf-8&key=%s, 91q.com\n    酷狗音乐, https://www.kugou.com/yy/html/search.html#searchType=song&searchKeyWord=%s\n    网易云音乐, http://music.163.com/#/search/m/?s=%s\n\n图片-花瓣网\n    Google图片, https://www.google.com/search?q=%s&safe=off&hl=zh-CN&tbm=isch\n    百度图片, http://image.baidu.com/search/index?tn=baiduimage&ie=utf-8&word=%s\n    Pixiv, http://www.pixiv.net/search.php?word=%s\n    Iconfont, https://www.iconfont.cn/search/index?searchType=icon&q=%s\n\n知识-知乎\n    百度百科, http://baike.baidu.com/search/word?pic=1&sug=1&word=%s\n    维基百科, https://zh.wikipedia.org/w/index.php?title=Special%3A搜索&profile=default&fulltext=Search&search=%s\n    谷歌学术, https://scholar.google.com/scholar?q=%s\n    知乎, http://www.zhihu.com/search?q=%s\n    百度文库, http://wenku.baidu.com/search?word=%s&ie=utf-8\n\n社交-Facebook\n    新浪微博, http://s.weibo.com/weibo/%s\n    豆瓣, http://www.douban.com/search?source=suggest&q=%s\n    百度贴吧, http://tieba.baidu.com/f?kw=%s&ie=utf-8\n    Twitter, https://twitter.com/search/%s\n    Facebook, https://www.facebook.com/search/top?q=%s\n\n购物-淘宝\n    淘宝, http://s.taobao.com/search?q=%s\n    京东, http://search.jd.com/Search?keyword=%s&enc=utf-8\n    当当, http://search.dangdang.com/search.php?key=%s, gbk\n    亚马逊, http://www.amazon.cn/s/ref=nb_sb_noss?field-keywords=%s\n\n下载\n    btsow, https://btsow.hair/search/%s\n    移花宫, https://yhg007.com/search-%s-0-0-1.html\n    磁力狗, http://clg5.info/search?word=%s\n    种子搜, https://www.zhongziso.com/list/%s/1\n    磁力猫, https://www.torkitty.com/search/%s, btdigg.org\n\n书籍-豆瓣读书\n    豆瓣读书, http://book.douban.com/subject_search?search_text=%s&cat=1001, www.douban.com\n    Google 书籍, http://books.google.com/books?q=%s, www.google.com\n    当当, http://search.dangdang.com/search.php?key=%s, gbk\n    亚马逊（中）, http://www.amazon.cn/s/ref=nb_sb_noss?field-keywords=%s\n\n翻译-爱词霸\n    Google翻译, https://translate.google.com/?q=%s\n    百度翻译, http://fanyi.baidu.com/#auto/cht/%s\n    有道词典, http://dict.youdao.com/search?q=%s\n    爱词霸, http://www.iciba.com/%s\n\n成人-javlibrary\n    javlibrary, http://www.javlibrary.com/cn/vl_searchbyid.php?keyword=%s\n    avmoo, https://avmoo.cfd/cn/search/%s\n    avsox, https://avsox.click/cn/search/%s\n    pornhub, http://www.pornhub.com/video/search?search=%s\n    t66y, https://www.google.com/search?q=site:t66y.com+%s, t66y.com\n    sis001, https://www.google.com/search?q=site:sis001.com+%s, sis001.com'
};
...
var rules = [
    ...
    {name: "google网页搜索",// 你要加载的网站的名字(方便自己查找)
        ...
        insertIntoDoc: {
           ...
           keyword: function() {
               var str = document.querySelector('textarea[name="q"][type="search"]').value;
               //alert(str);
...
//    },
    ...
    {name: "雅虎日本",
        ...
        ",
        insertIntoDoc: {
        keyword: 'css;.SearchBox__searchInput',
        target: 'css;body',
        where: 'beforeBegin'
        }
    },
    ...
    {name: "wikipedia",
        ...
        insertIntoDoc: {
            keyword: function() {
                //alert(1);
                var input = document.querySelector('input#ooui-php-1');
                //alert(input.value);
                if (input) return input.value;
            },
...
//    },
    ...
    {name: "知乎",
        ...
        ',
        insertIntoDoc: {
            keyword: 'css;input#Popover1-toggle',
            target: 'css;body',
            where: 'beforeBegin'
        },
    ...
    {name: "百度文库",
        ...
        insertIntoDoc: {
            keyword: function() {
                //alert(1);
                var str = document.querySelector('span.hot-option-word-content').innerHTML;
                //alert(str);
                return str;
            },
            target: 'css;.search-box-wrapper',
            where: 'afterBegin'
        }
    },
    {name: "豆丁",
        ...
        ',
        insertIntoDoc: {
            keyword: 'css;input.search_input',
            target: 'css;div.result_top_wrap',
            where: 'afterEnd'
        }
    },
    ...
    {name: "youtube",
        ...
        insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = document.getElementsByTagName("title")[0].text;
               str = str.replace(" - YouTube","");
               //alert(str);
               return str;
            },
           target: 'id("masthead-container")',
           where: 'beforeEnd',
        },
    },
    {name: "niconico",
    ...
    {name: "iqiyi",
        ...
        style: '\
               ...
               ',
        insertIntoDoc: {
           keyword: 'css;.search-box-input',
           target: 'css;.qy-search-navigat',
           where: 'afterEnd'
        },
    },
    {name: "Letv",
        url: /^https?:\/\/so\.le(tv)?\.com\/s\?/,
        enabled: true,
        engineList: "video",
        style: "\
               margin:0 auto;\
    ...
    {name: "百度音乐",
        ...
        insertIntoDoc: {
            keyword: function() {
                //alert(1);
                var str = document.title.split("-")[1];
                //alert(str);
                return str;
            },
            target: 'css;body',
    ...
    {name: "酷狗音乐",
        url: /^https?:\/\/www\.kugou\.com\/[a-z\.\/]+search/,
        enabled: true,
        engineList: "music",
        style: "\
            word-break:keep-all;\
    ...
    {name: "酷我音乐",
        ...
        insertIntoDoc: {
            keyword: function() {
                //alert(1);
	            var str = document.querySelector('meta[name=keywords]').content.split(",")[0];
                //alert(str);
                return str;
            },
            target: 'css;body',
    ...
    {name: "谷歌图片",
        ...
        insertIntoDoc: {
            keyword: function() {
                //alert(1)
                var str = document.querySelector('input[name="q"][type="text"]').value;
                //alert(str);
                return str;
            },
            target: 'css;body',
    ...
    {name: "360图片",
        ...
        style: '\
            ...
            ',
        insertIntoDoc: {
            keyword: 'css;input.so-search__input',
            target: 'css;.so-header',
            where: 'afterBegin'
        },
        etc: function() {
    ...
    {name: "pixiv",
        ...
        insertIntoDoc: {
            ...
            keyword: function() {
               ...
               str=decodeURI(str.match(/^#(.+)のイラスト/)[1]);
               //alert(str);
                //document.write(str+"</br>");
    ...
    //},
    {name: "iconfont",
        url: /^https?:\/\/www\.iconfont\.cn\/search/,
        engineList: "image",
        enabled: true,
        style: "\
            margin-bottom:1px;\
    ...
    //},
    {name: "btsow",
		url: /^https?:\/\/(www\.)?btsow\.hair\/search/,
		enabled: true,
		engineList: "download",
		style: '\
			   word-break:keep-all;\
    ...
    {name: "thepiratebay",
		...
		insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = document.querySelector("input#search").value;
               //alert(str);
               return str;
            },
            target: 'css;body',
    ...
    {name: "torrentkitty",
        url: /^https?:\/\/(www\.)?tor(rent)?kitty\.(com|org|net|tv)\/search\//,
        enabled: true,
        engineList: "download",
        style: '\
               border-top:1px solid #FFFFFF;\
        ...
        insertIntoDoc: {
           keyword: function() {
               var str = document.getElementsByTagName("h2")[0].innerHTML.slice(18, -1);
               //alert(str);
               return str;
           },
           target: 'css;.wrapper',
    ...
    {name: "小草磁力-BTHub",
        url: /^https?:\/\/(www\.)?(xccl55|bthub031)\.xyz(\/cn)?\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "磁力蜘蛛",
        url: /^https?:\/\/(www\.)?btmovi\.[a-z]{2,6}\/so/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "btmet",
        url: /^https?:\/\/(www\.)?btmet[0-9]{2,3}\.[a-z]{2,6}\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "移花宫",
        url: /^https?:\/\/(www\.)?yhg007\.com\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "磁力猫",
        url: /^https?:\/\/(www\.)?clmclm\.com\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "雨花阁",
        url: /^https?:\/\/(www\.)?yuhuage\.[a-z]{3,6}\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "磁力帝",
        url: /^https?:\/\/(www\.)?cld[0-9]{2,3}\.buzz\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "磁力狗",
        url: /^https?:\/\/(www\.)?clg5\.info\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
        ...
        insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = document.querySelector("input#SearchForm_keyword").value;
               //alert(str);
               return str;
            },
            target: 'css;#head',
    ...
    {name: "种子吧",
        ...
        insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = document.querySelector("input.form-control").value;
               //alert(str);
               return str;
            },
            target: 'css;.serach-con',
            where: 'afterBegin'
        }
    },
    {name: "种子搜",
        url: /^https?:\/\/(www\.)?zhongziso\.com\/list/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "0magnet",
        url: /^https?:\/\/(www\.)?(0cili|0magnet)\.(com|org)\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "xuesousou",
        url: /^https?:\/\/(www\.)?xuesousou\.com\/search/,
        enabled: true,
        engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "沪江英语",
        url: /^https?:\/\/dict\.hjenglish\.com\/(\w+\/)?(en|w)/,
        enabled: true,
        engineList: "translate",
        style: "\
            margin:0 auto;\
    ...
    {name: "沪江日语",
        url: /^https?:\/\/dict\.hjenglish\.com\/(\w+\/)?jp/,
        enabled: true,
        engineList: "translate",
        style: "\
            margin:0 auto;\
    ...
    {name: "romajidesu",
        url: /^https?:\/\/www\.romajidesu\.com\/translator/,
        enabled: true,
        engineList: "translate",
        style: "\
            margin:0 auto;\
        ...
        insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = document.querySelector('textarea#japanese_input').innerHTML;
               //alert(str);
               return str;
            },
            target: 'css;body',
    ...
    {name: "google翻译",
        ...
        insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = document.querySelector('textarea[role="combobox"]').innerHTML;
               //alert(str);
               return str;
            },
            target: 'css;body',
    ...
    {name: "百度翻译",
        ...
        insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = decodeURI(document.URL.match(/#\w{2,3}\/\w{2,3}\/(.+?)$/)[1]);
               //alert(str);
               return str;
            },
            target: 'css;body',
    ...
    {name: "weibo",//===========================================================================================================================================================================
        ...
        insertIntoDoc: {
            ...
            keyword: function() {
               return document.querySelector('input[node-type="text"]').value;
            },
            target: 'css;.m-search',
            where: 'beforeBegin'
        }
    ...
    {name: "Twitter",
        ...
        insertIntoDoc: {
           keyword: function() {
                //alert(1)
                var str = decodeURI(document.URL.match(/q=(.+?)(&|$)/)[1]);
                //alert(str);
                return str;
            },
            target: 'css;body',
    ...
    //成人
    {name: "javlibrary(搜索页)",
        url: /^https?:\/\/www\.javlibrary\.com\/[a-z]{2}\/.*search/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
        ...
        insertIntoDoc: {
            ...
            keyword: function() {
                //alert(1);
                var str = document.querySelector('div.boxtitle').innerHTML.match(/\"(.*)\"/)[1];
                //alert(str);
                return str;
            },
            target: 'css;body',
    ...
    {name: "javlibrary(结果页)",
        url: /^https?:\/\/www\.javlibrary\.com\/[a-z]{2}\/\?v/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
    ...
    {name: "AVMOO(搜索页)",
        url: /^https?:\/\/(www\.)?avmoo\.cfd\/[a-z]{2}\/search/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
    ...
    {name: "AVMOO(结果页)",
        url: /^https?:\/\/(www\.)?avmoo\.cfd\/[a-z]{2}\/movie/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
    ...
    {name: "AVSOX(搜索页)",
        url: /^https?:\/\/(www\.)?avsox\.click\/[a-z]{2}\/search/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
    ...
    {name: "AVSOX(结果页)",
        url: /^https?:\/\/(www\.)?avsox\.click\/[a-z]{2}\/movie/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
    ...
    {name: "PronMD",
        url: /^https?:\/\/(www\.)?pornmd\.com\/straight/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
        ...
        insertIntoDoc: {
            keyword: function() {
               //alert(1);
               var str = document.querySelector('input[type="text"]').value;
               //alert(str);
               return str;
            },
            target: 'css;body',
    ...
    {name: "pornhub",
        url: /^https?:\/\/[a-z]{2,3}\.pornhub\.com\/.*search/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
        ...
        insertIntoDoc: {
           keyword: function() {
               //alert(1);
               var str = document.querySelector('input#searchInput').value;
               //alert(str);
               return str;
            },
            target: 'css;body',
    ...
    {name: "dmm",
        ...
        insertIntoDoc: {
            keyword: function() {
               //alert(1);
               var str = document.querySelector('input[name="searchstr"]').value;
               //alert(str);
               return str;
            },
            target: 'css;body',
